...
``` {r}
#df <- read.csv("Late20C_data/ICPSR_08187-V1_1982StateMSADataBook/ICPSR_08187/DS0002/08187-0002-Data.txt")

#df <- read.table("Late20C_data/ICPSR_08187-V1_1982StateMSADataBook/ICPSR_08187/DS0002/08187-0002-Data.txt",header=TRUE)

setwd("C:/Users/F0040RP/documents/DartLib_RDS/censusData")

#https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/read.fwf

colwidths1<-c(3,1,1,2,4,4,5,2,55,rep(11,172))
colwidths2<-c(3,1,1,2,4,4,5,2,rep(11,176))

data1980<-read.fwf("Late20C_data/ICPSR_08187_v1_StateMetDataBook1982/DS0002/08187-0002-Data.txt", widths = list(colwidths1,colwidths2)) 

# data1980<-read.fwf("Late20C_data/ICPSR_08187-V1_StateMetDataBook1982/ICPSR_08187/DS0002/08187-0002-Data.txt", widths = list(colwidths1,colwidths2)) 

colnames(data1980)[1:15]<-c("id","seg","geoLevel","FIPS_SCSA","FIPS_SMSA","FIPS_NECMA","FIPS_STCTY","Filler","GeoName","landArea","poptot1980","SMSArank","perSqMi","poptot1970","poptot1960")
...
# finding data on Nat Am and total pops

```{r}
natpop2000 <- get_decennial(geography = "county", 
                       variables = c("P003005", "P001001"), 
                       geometry=FALSE,
                       year = 2000)
head(natpop2000)
...
```{r}
# natpop2000b <- reshape(natpop2000, idvar = c("GEOID", "NAME"), v.names = "variable", timevar = "variable", direction = "wide")
natpop2000_wide <- spread(natpop2000, key = variable, value)
head(natpop2000_wide)
natpop2000_wide <- rename(natpop2000_wide, totpop2000 = P001001, natpop2000 = P003005)

```


```{r}
natpop2010 <- get_decennial(geography = "county", 
                       variables = c("P003004", "P001001"), #note: NatAm (alone pop) is P003004 vs 05 for 2000
                       geometry=FALSE,
                       year = 2010)
...
```{r}
natpop2010_wide <- spread(natpop2010, key = variable, value)
natpop2010_wide <- rename(natpop2010_wide, totpop2010 = P001001, natpop2010 = P003004)
head(natpop2010_wide)

```

```{r}
natpop2020 <- get_decennial(geography = "county", 
                       variables = c("P1_005N", "P1_001N"), #note: NatAm (alone pop) is P003004 vs 05 for 2000
                       geometry=FALSE,
                       year = 2020)
natpop2020_wide <- spread(natpop2020, key = variable, value)
natpop2020_wide <- rename(natpop2020_wide, totpop2020 = P1_001N, natpop2020 = P1_005N)
head(natpop2020_wide)
```

```{r}

natpop2000_10 <- merge(natpop2000_wide, natpop2010_wide, by = "GEOID")
natpop2000_20 <- merge(natpop2000_10, natpop2020_wide, by = "GEOID")
natpop2000_20 <- subset(natpop2000_20, select=-c(NAME.x, NAME.y))
head(natpop2000_20)
```

```{r}

natpop2000_20 <- natpop2000_20[,order(colnames(natpop2000_20))]
write.csv(natpop2000_20, "US_NatAmPop_2000-20.csv", row.names = FALSE)
