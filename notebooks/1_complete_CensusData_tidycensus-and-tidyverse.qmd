...
1.  Request a key [here](https://api.census.gov/data/key_signup.html).
    ...
    1.  Then check your email, select "click here to activate your key."
    ...
    **Option 1**
    ...
    `{r} census_api_key("{insert census api key here}", install = TRUE) #readRenviron("~/.Renviron")}`
...
write.csv(vars2020dhc, "DHC2020_variables.csv", row.names=FALSE)
```
