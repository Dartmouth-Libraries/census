...
2.  Data in a Democracy: Uses, Misuses, & Abuses
3.  Data & the Human Stories Behind it
4.  
5.  Data \@ Dartmouth: Datasets --\> Social Explorer
...
-   empirical research: "look to the data"

    -   historical demography project, University of Colorado - 1940 census

    -   social science research, policy-making, problem-solving

-   Data Humanism: reflecting on how human fallibility is embedded in our data

::: notes
-   democracy - vulnerable / historical irregularity

-   Demographic Data - Values

    -   Representation

    -   Policy, Services, & Problem-Solving

    -   Historical Value: Jeremy: historical demography project, University of Colorado - 1940 census

-   Dangers

    -   surveillance

    -   tool of exploitation or oppression
:::
...
# From Census Collection to Census Data {.scrollable}
...
1.  Census Data / American Community Survey (ACS)
    1.  recent (**Census API** / **tidycensus (R)**) \<\-- Workshop 2 / 3
    2.  historical (**ICPSR**)
2.  Original census forms & other genealogical records: Library's ***Ancestry*** account

## Surveys & Polls

1.  **Gallup Poll** dataset
    1.  World
    2.  U.S.
...
1.  Full texts from newspapers / magazines from **ProQuestTDM**
2.  Full texts from newspapers + TV news transcripts: **Nexis Uni**

## Judicial Records / Case Law
